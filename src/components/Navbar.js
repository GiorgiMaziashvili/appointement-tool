    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center">
          ...
          >
            <span className="sr-only">გვერდითი პანელის გახსნა</span>
          ...
          <div className="ml-4 md:ml-0">
            ...
            <p className="text-sm text-gray-600">
              მართეთ ექიმები და ვიზიტები ეფექტურად
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 rounded-full">
            <span className="sr-only">შეტყობინებების ნახვა</span>
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center">
            <div className="w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center">
              <span className="text-white text-sm font-medium">ა</span>
            </div>
